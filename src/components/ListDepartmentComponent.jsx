...
const ListDepartmentComponent = () => {
  ...
  const { departments, loading, error, fetchDepartments, deleteDepartment, clearError } =
    useDepartmentStore();
  ...
  return (
    <div className="page-container">
          ...
          <div>
            ...
            {departments.map((department) => (
              <div key={department.id} className="data-table-row department-table-row">
                ...
                <div>
                  <span className="badge badge-purple">{department.departmentName}</span>
                </div>
      ...
      <div className="total-count">Total Departments: {departments.length}</div>
    </div>
  );
};
